                ...
                <div class="relative p-6">
                    <div class="flex items-center justify-between">
                        <div class="flex-1 min-w-0">
                            <p class="text-xs sm:text-sm font-semibold text-amber-100 uppercase tracking-wide">Mantenim.</p>
                            <p class="mt-2 text-5xl font-black text-white drop-shadow-lg">{{ $mantenimiento }}</p>
                            <p class="mt-2 text-xs sm:text-sm font-medium text-white/80">En servicio</p>
                        </div>
                        <div class="p-4 bg-white/20 rounded-2xl backdrop-blur-sm flex-shrink-0">
                            <svg class="w-12 h-12 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
