    ...
    <div class="flex h-screen overflow-hidden" x-data="{ sidebarOpen: false }">
        ...
        <div x-show="sidebarOpen" x-cloak class="fixed inset-0 z-40 flex md:hidden">
            ...
            <div class="relative flex flex-col flex-1 w-full max-w-xs bg-gray-900">
                ...
                <nav class="flex-1 px-2 py-4 space-y-1 overflow-y-auto">
                    <a href="{{ route('dashboard') }}" class="flex items-center px-4 py-3 text-sm font-medium text-gray-300 rounded-lg hover:bg-gray-800 hover:text-white">
                        Dashboard
                    </a>
                    <a href="{{ route('camiones.index') }}" class="flex items-center px-4 py-3 text-sm font-medium text-gray-300 rounded-lg hover:bg-gray-800 hover:text-white">
                        Camiones
                    </a>
                </nav>
            </div>
