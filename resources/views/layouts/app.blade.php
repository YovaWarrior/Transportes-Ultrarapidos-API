    ...
    <div class="flex h-screen overflow-hidden" x-data="{ sidebarOpen: false }">
        ...
        <div x-show="sidebarOpen" x-cloak class="fixed inset-0 z-40 flex md:hidden">
            ...
            <div class="relative flex flex-col flex-1 w-full max-w-xs bg-gray-900">
                ...
                <!-- User Menu Mobile -->
                <div class="flex-shrink-0 p-4 border-t border-gray-800 bg-gray-900">
                    <div class="flex items-center">
                        <div class="flex-shrink-0">
        ...
        <div class="flex flex-col flex-1 w-0 overflow-hidden">
            ...
            <main class="relative flex-1 overflow-y-auto focus:outline-none">
                <!-- Flash Messages -->
                @if(session('success'))
                    <div x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 5000)" class="m-4 p-4 bg-green-50 border-l-4 border-green-500 rounded-lg shadow-lg">
                ...
                @if(session('error'))
                    <div x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 5000)" class="m-4 p-4 bg-red-50 border-l-4 border-red-500 rounded-lg shadow-lg">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
